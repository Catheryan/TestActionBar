...
public class ActionBarManager {
	...
	public static void initTitleXidingyiActionBar(Context mContext,ActionBar actionBar){
		Log.i("testab", "actionbar");
		...
		LayoutInflater inflator = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View centerTitle = inflator.inflate(R.layout.qqtwochanged, null);
		ActionBar.LayoutParams layoutParams = new ActionBar.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
